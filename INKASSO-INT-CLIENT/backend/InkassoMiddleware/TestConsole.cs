...
{
    /// <summary>
    /// Console application for testing the raw SOAP client
    /// </summary>
    public class TestConsole
    {
        ...
        {
            Console.WriteLine("=== Inkasso Raw SOAP Client Console Test ===");
            Console.WriteLine("This console application tests the raw SOAP client for the Inkasso API.");
            Console.WriteLine();
